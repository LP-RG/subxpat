...
def get_toolname(specs_obj: Specifications) -> str:
    message, toolname = {
        ...
        (False, TemplateType.MULTI_LEVEL): ('Multilevel XPAT', sxpatconfig.MULTILEVEL_XPAT),
        ...
        (True, TemplateType.MULTI_LEVEL): ('Multilevel SubXPAT', sxpatconfig.MULTILEVEL_SUBXPAT),
