...
def nine(s_graph: SGraph, t_graph: PGraph, max_error: int, beta: int, alpha: int) -> List[AnyNode]:
...
def nine_prime(s_graph: SGraph, t_graph: PGraph, max_error: int, beta: int, alpha: int, c_constant: int) -> List[AnyNode]:
