...
mode_11_data = {
    "Error Space 4": {
        "Original": [0, 4, 2, 2, 2, 3],
        "Refactored": [0, 4, 2, 2, 2, 3]
    },
    "Error Space 8": {
        "Original": [0, 4, 2, 2, 2, 3, 8, 2, 3, 3, 6, 5, 8],
        "Refactored": [0, 4, 2, 2, 2, 3, 8, 2, 3, 3, 3, 4, 5, 8]
    },
    "Error Space 16": {
        "Original": [2, 7, 4, 4, 4, 4, 8, 8, 7, 8, 8, 8, 8, 8],
        "Refactored": [2, 7, 4, 4, 8, 8, 8, 7, 7, 8, 8, 8, 8]
    },
    "Error Space 32": {
        "Original": [5, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8],
        "Refactored": [5, 8, 8, 8, 8, 7, 8, 7, 8, 8, 10, 8, 8, 8, 8]
    },
    "Error Space 64": {
        "Original": [8, 8, 14, 14, 14, 14, 8, 10, 8, 7, 7, 7, 6, 5, 6, 3, 3, 3],
        "Refactored": [8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 7, 4, 3]
    }
}
...
mode_12_data = {
    "Error Space 4": {
        "Original": [0, 4, 2, 2, 8],
        "Refactored": [0, 4, 2, 2, 8]
    },
    "Error Space 8": {
        "Original": [0, 4, 2, 2, 8, 4, 6, 6, 6, 8],
        "Refactored": [0, 4, 2, 2, 8, 4, 6, 6, 6, 8]
    },
    "Error Space 16": {
        "Original": [2, 7, 4, 4, 4, 4, 8, 6, 7, 8, 8, 7, 7, 8, 7, 8],
        "Refactored": [2, 7, 4, 4, 4, 4, 8, 8, 7, 8, 8, 8, 8, 8, 8]
    },
    "Error Space 32": {
        "Original": [5, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8],
        "Refactored": [5, 8, 8, 7, 7, 8, 8, 8, 8, 8, 8, 8]
    },
    "Error Space 64": {
        "Original": [8, 8, 8, 8, 12, 14, 8, 8, 8, 7, 7, 4, 4, 4, 4, 4, 4],
        "Refactored": [8, 8, 14, 14, 14, 14, 8, 14, 14, 14, 14, 14]
    }
}
...
plot_extraction_results("Mode 11", mode_11_data)
plot_extraction_results("Mode 12", mode_12_data)
