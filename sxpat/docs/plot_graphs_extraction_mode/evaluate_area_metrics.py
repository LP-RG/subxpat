...
all_modes_data = {
    ...
    "Mode 6": {
        'Error Space 4': {'x_post': [], 'y_pre': [140.79], 'color': 'blue'},
        'Error Space 8': {'x_post': [], 'y_pre': [132.343], 'color': 'green'},
        'Error Space 16': {'x_post': [], 'y_pre': [159.093], 'color': 'yellow'},
        'Error Space 32': {'x_post': [], 'y_pre': [129.527], 'color': 'orange'},
