    ...
    def relative_error_zone_constraint(cls, s_graph: SGraph, t_graph: PGraph, error_threshold: int, 
        ...
        return [
            ...
            *(PlaceHolder(name) for name in s_graph.inputs_names[len(s_graph.inputs_names)//2:]),
            ...
            et_1 := IntConstant('et_1', value=int(error_threshold+5)),
            et_2 := IntConstant('et_2', value=int(error_threshold+10)),
            et_3 := IntConstant('et_3', value=int(error_threshold+15)),
            zero_costant := IntConstant('zero_costant', value = 0),
            one := IntConstant('one', value = 1),
            zone_limit_0 := IntConstant('zone_limit_0', value = 2),
            zone_limit_1 := IntConstant('zone_limit_1', value = 12),
            hundred := IntConstant('hundred', value = 100),
            condition := Equals('condition', operands = (cur_int, zero_costant)),
            divider := If("divider", operands=(condition, one, cur_int)),
            h_0_lessequal := LessEqualThan('h_0_lessequal', operands=(input_one_value,zone_limit_0)),
            h_0_greater := GreaterThan('h_0_greater', operands=(input_one_value,zone_limit_0)),
            h_1_lessequal := LessEqualThan('h_1_lessequal', operands=(input_one_value,zone_limit_1)),
            h_1_greater := GreaterThan('h_1_greater', operands=(input_one_value,zone_limit_1)),
            v_0_lessequal := LessEqualThan('v_0_lessequal', operands=(input_two_value,zone_limit_0)),
            v_0_greater := GreaterThan('v_0_greater', operands=(input_two_value,zone_limit_0)),
            v_1_lessequal := LessEqualThan('v_1_lessequal', operands=(input_two_value,zone_limit_1)),
            v_1_greater := GreaterThan('v_1_greater', operands=(input_two_value,zone_limit_1)),
            zone_0 := And('zone_0', operands=(h_0_lessequal, v_0_lessequal)),
            zone_1 := And('zone_1', operands=(h_1_lessequal, v_0_greater, v_1_lessequal)),
            zone_2 := And('zone_2', operands=(h_0_lessequal, v_0_greater)),
            zone_3 := And('zone_3', operands=(v_0_lessequal, h_0_greater, h_1_lessequal)),
            zone_4 := And('zone_4', operands=(v_1_greater, h_0_greater, h_1_lessequal)),
            zone_5 := And('zone_5', operands=(v_0_lessequal, h_1_greater)),
            zone_6 := And('zone_6', operands=(v_1_greater, h_1_greater)),
            abs_diff_hundred := Mul('abs_diff_hundred', operands=(abs_diff, hundred)),
            rel_diff := UDiv('rel_diff',operands=(abs_diff_hundred, divider)),
            ...
            error_3 := LessEqualThan('error_3', operands=(rel_diff, et_3)),
            zone_et_0 := Or('zone_et_0', operands=(zone_0, zone_3)),
            zone_et_1 := Or('zone_et_1', operands=(zone_1, zone_2, zone_5)),
            ec_0 := Implies('ec_0', operands=(zone_et_0, error_0)),
            ec_1 := Implies('ec_1', operands=(zone_et_1, error_1)),
            ec_2 := Implies('ec_2', operands=(zone_4, error_2)),
            ec_3 := Implies('ec_3', operands=(zone_6, error_3)),
            error_check := And("error_check", operands=(ec_0, ec_1, ec_2, ec_3))
        ]
