...
class _NonSharedBase:
    ...
    #         condition := Equals('condition', operands = (cur_int, zero_costant)),
    #         divider := If("divider", operands=(condition, one, cur_int)),
    #         zone_h_lessequal := LessEqualThan('zone_h_lessequal', operands=(input_one_value,zone_limit)),
    #         zone_h_greater := GreaterThan('zone_h_greater', operands=(input_one_value,zone_limit)),
    #         zone_v_lessequal := LessEqualThan('zone_v_lessequal', operands=(input_two_value,zone_limit)),
    #         zone_v_greater := GreaterThan('zone_v_greater', operands=(input_two_value,zone_limit)),
    #         zone_0 := And("zone_0", operands=(zone_h_lessequal, zone_v_lessequal)),
    #         zone_1 := And("zone_1", operands=(zone_h_greater, zone_v_lessequal)),
    #         zone_2 := And("zone_2", operands=(zone_h_lessequal, zone_v_greater)),
    #         abs_diff_hundred := Mul('abs_diff_hundred', operands=(abs_diff, hundred)),
    #         rel_diff := UDiv('rel_diff',operands=(abs_diff_hundred, divider)),
    ...
    def relative_error_zone_constraint_xx(cls, s_graph: SGraph, t_graph: PGraph, error_threshold: int, 
                                             zone_constraint: int) -> List[Node]:
        return [
            *(PlaceHolder(name) for name in s_graph.inputs_names[:len(s_graph.inputs_names)//2]),
            input_one_value := ToInt('input_one', operands=s_graph.inputs_names[:len(s_graph.inputs_names)//2]),
            *(PlaceHolder(name) for name in s_graph.inputs_names[len(s_graph.inputs_names)//2:]),
            ...
            abs_diff := AbsDiff('abs_diff', operands=(cur_int, tem_int,)),
            et_0 := IntConstant('et_0', value=error_threshold),
            et_1 := IntConstant('et_1', value=error_threshold+5),
            et_2 := IntConstant('et_2', value=error_threshold+10),
            et_3 := IntConstant('et_3', value=error_threshold+15),
            zero_costant := IntConstant('zero_costant', value = 0),
            one := IntConstant('one', value = 1),
            zone_constraint_0 := IntConstant('zone_limit_h', value = 2),
            zone_constraint_1 := IntConstant('zone_limit_h', value = 12),
            zone_limit_0 := IntConstant('zone_limit_0', value = (zone_constraint_0)),
            zone_limit_1 := IntConstant('zone_limit_1', value = (zone_constraint_1)),
            hundred := IntConstant('hundred', value = 100),
            condition := Equals('condition', operands = (cur_int, zero_costant)),
            divider := If("divider", operands=(condition, one, cur_int)),
            h_0_lessequal := LessEqualThan('h_0_lessequal', operands=(input_one_value,zone_limit_0)),
            h_0_greater := Not('h_0_greater', operands=h_0_lessequal),
            h_1_lessequal := LessEqualThan('h_1_lessequal', operands=(input_one_value,zone_limit_1)),
            h_1_greater := Not('h_1_greater', operands=(h_1_lessequal)),
            v_0_lessequal := LessEqualThan('v_0_lessequal', operands=(input_two_value,zone_limit_0)),
            v_0_greater := Not('v_0_greater', operands=v_0_lessequal),
            v_1_lessequal := LessEqualThan('v_1_lessequal', operands=(input_two_value,zone_limit_1)),
            v_1_greater := Not('v_1_greater', operands=(v_1_lessequal)),
            zone_0 := And('zone_0', operands=(h_0_lessequal, v_0_lessequal)),
            zone_1 := And('zone_1', operands=(h_0_greater, h_1_lessequal, v_1_lessequal)),
            zone_2 := And('zone_2', operands=(h_1_greater, v_0_lessequal)),
            zone_3 := And('zone_3', operands=(h_0_lessequal, v_0_greater, v_1_lessequal)),
            zone_4 := And('zone_4', operands=(h_1_greater, v_0_greater, v_1_lessequal)),
            zone_5 := And('zone_5', operands=(h_0_lessequal, v_1_greater)),
            zone_6 := And('zone_6', operands=(h_1_greater, v_1_greater)),
            abs_diff_hundred := Mul('abs_diff_hundred', operands=(abs_diff, hundred)),
            rel_diff := UDiv('rel_diff',operands=(abs_diff_hundred, divider)),
            error_0 := LessEqualThan('error_0', operands=(rel_diff, et_0)),
            ec_0 := Implies("ec_0", operands=(zone_0,error_0)),
